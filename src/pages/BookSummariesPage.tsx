...
const BookSummariesPage: React.FC = () => {
  ...
  const filteredBooks = mockSummaries.filter(book => {
          ...
          {filteredBooks.map(summary => {
            ...
            return (
              <Link
                ...
                key={summary.id}
                className="bg-[#3a2819] rounded-lg overflow-hidden border border-[#7a4528] hover:border-[#c9a52c] transition-all duration-200"
              >
                <div className="relative aspect-[3/2] overflow-hidden">
                  ...
                  {summary.isPremium && (
                    <div className="absolute bottom-0 right-0 p-2">
                      <span className="inline-flex items-center gap-1 px-2 py-1 rounded bg-black/50 text-xs">
                        <Lock size={12} />
                        Premium
                      </span>
                    </div>
